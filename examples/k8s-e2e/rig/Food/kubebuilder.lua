...
local etcd = "etcd"
local apiserver = "kube-apiserver"
    ...
    packages = {
        {
            ...
            resources = {
                ...
                {
                    path = name .. "_" .. version .. "_darwin_amd64" .. "/bin/" .. etcd,
                    installpath = "bin/" .. etcd,
                    executable = true
                },
                {
                    path = name .. "_" .. version .. "_darwin_amd64" .. "/bin/" .. apiserver,
                    installpath = "bin/" .. apiserver,
                    executable = true
                }
            }
        },
        {
            ...
            resources = {
                ...
                {
                    path = name .. "_" .. version .. "_linux_amd64" .. "/bin/" .. etcd,
                    installpath = "bin/" .. etcd,
                    executable = true
                },
                {
                    path = name .. "_" .. version .. "_linux_amd64" .. "/bin/" .. apiserver,
                    installpath = "bin/" .. apiserver,
                    executable = true
                }
            }
